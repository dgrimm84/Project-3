  ...
  .then((data) => {
    if (data.data && Array.isArray(data.data)) {
      ...
      data.data.forEach((park) => {
        ...
        let parkIconUrl;
        if (feeAmount === 0) {
          parkIconUrl = 'assets/Images/tree-green.svg';
        } else if (feeAmount > 0 && feeAmount <= 10) {
          parkIconUrl = 'assets/Images/tree-yellow.svg';
        } else if (feeAmount > 10 && feeAmount <= 20) {
          parkIconUrl = 'assets/Images/tree-orange.svg';
        ...
        let monumentIconUrl;
        if (feeAmount === 0) {
          monumentIconUrl = 'assets/Images/monument-green.svg';
        } else if (feeAmount > 0 && feeAmount <= 10) {
          monumentIconUrl = 'assets/Images/monument-yellow.svg';
        } else if (feeAmount > 10 && feeAmount <= 20) {
          monumentIconUrl = 'assets/Images/monument-orange.svg';
        } else if (feeAmount > 20) {
          monumentIconUrl = 'assets/Images/monument-red.svg';
        }

        // Assign the proper color of the Memorial icon based on the range of Entrance Fee Amount
        let memorialIconUrl;
        if (feeAmount === 0) {
          memorialIconUrl = 'assets/Images/memorial-green.svg';
        } else if (feeAmount > 0 && feeAmount <= 10) {
          memorialIconUrl = 'assets/Images/memorial-yellow.svg';
        } else if (feeAmount > 10 && feeAmount <= 20) {
          memorialIconUrl = 'assets/Images/memorial-orange.svg';
        } else if (feeAmount > 20) {
          memorialIconUrl = 'assets/Images/memorial-red.svg';
        }
...
parkTypeLegendContainer.innerHTML = `
  ...
  <div style="display: flex; align-items: center; margin-bottom: 8px;">
    <img src="assets/Images/tree-green.svg" style="width: 22px; height: 22px;" />
  ...
  <div style="display: flex; align-items: center; margin-bottom: 8px;">
    <img src="assets/Images/monument-green.svg" style="width: 22px; height: 22px;" />
  ...
  <div style="display: flex; align-items: center;">
    <img src="assets/Images/memorial-green.svg" style="width: 22px; height: 22px;" />
